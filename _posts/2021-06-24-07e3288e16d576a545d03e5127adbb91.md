...
[image:179ADA25-DC31-4183-B3EE-7378D4136FD2-6324-0000083A77B48AD7/image.png]  
  
이런 순차데이터는 순환층을 이용하여 처리하는데 출력을 다시 입력에 넣어서 순환시키는 구조이다.  
  
[image:DEE06765-C47A-4FDB-82EB-C5F3C527A9C0-6324-0000083A777BA6F9/image 2.png]  
  
순환구조에는 지난번에 소개했던 `하이퍼볼릭탄젠트 함수`를 사용한다. 그리고 위와 같은 신경망 중 순환신경망을 `셀`이라고 부른다. 단위를 나눈다는 것은 추상화해서 감추겠다는 것이겠지. 늘 그렇듯.  
  
[image:C291A221-C766-4D30-AEA9-1F1B62B751B3-6324-0000083A7745EA5F/image 3.png]  
...
[image:0D6002F0-2DD3-4EDE-9D8E-3BAE716B7BD5-378-000003BB439B62BF/0ECF0140-4966-47FB-BF42-AF064BDBCEA5.png]  
