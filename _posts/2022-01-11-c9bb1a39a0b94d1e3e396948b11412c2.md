...
[image:BA5CB277-91DA-4772-9E5A-D27699EB4266-23169-000005317881B71E/image.png]  
# *   
...
[image:2813671B-4988-4933-B019-03213026DA73-23169-0000053178807398/알 수 없음.gif]  
...
[image:BF96726D-9BEC-45AE-94C4-8E89DCF70C66-23169-00000531787F0EFE/알 수 없음.gif]  
## thenApply(Function)  
	CompletableFuture<String> future = CompletableFuture.supplyAsync(() -> {  
    System.out.println("Hello" + Thread.currentThread().getName());  
    return "Hello";  
...
[image:D29A4142-D77F-4304-9899-C01D95F75462-23169-00000531787D8571/알 수 없음.gif]  
## thenAccept(Consumer)  
...
[image:B9B66E66-BBC7-4B80-AC1E-F0DA9E11A5E7-23169-00000531787BF8ED/알 수 없음.gif]  
## thenRun(Runnable)  
CompletableFuture<Void> future = CompletableFuture.supplyAsync(() -> {  
    System.out.println("Hello" + Thread.currentThread().getName());  
    return "hello";  
...
[image:6C10FEE7-3D1E-4587-8B24-2B7302494168-23169-00000531787A4239/알 수 없음.gif]  
## : because of  
