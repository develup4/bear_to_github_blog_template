...
![]({{ site.url }}{{ site.baseurl }}/assets/images/2021-06-26-RNN/image.png)  
대표사진 삭제  
사진 설명을 입력하세요.  
이런 순차데이터는 순환층을 이용하여 처리하는데,  
출력을 다시 입력에 넣어서 순환시키는 구조이다.  
  
![]({{ site.url }}{{ site.baseurl }}/assets/images/2021-06-26-RNN/image%202.png)  
대표사진 삭제  
사진 설명을 입력하세요.  
순환구조에는 지난번에 소개했던 하이퍼볼릭탄젠트 함수를 사용한다.  
그리고 위와 같은 신경망 중 순환신경망은 셀이라고 부른다.  
  
![]({{ site.url }}{{ site.baseurl }}/assets/images/2021-06-26-RNN/image%203.png)  
대표사진 삭제  
사진 설명을 입력하세요.  
